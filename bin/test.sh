...
xcodebuild test -project Flight\ Risk\ Assessment\ Tool.xcodeproj/ -scheme Flight\ Risk\ Assessment\ Tool -destination 'platform=iOS Simulator,name=iPhone 6,OS=10.2'
